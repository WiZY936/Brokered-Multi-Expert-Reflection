...
class ReactAgent:
    ...
    def step(self) -> None:
        ...
        try:
            ...
            action_type, argument = None, None
        print(self.scratchpad.split('\n')[-1])
...
class ReactReflectAgent(ReactAgent):
    ...
    def reflect(self,
        ...
        if strategy == ReflexionStrategy.LAST_ATTEMPT:
            ...
            self.reflections += [self.prompt_reflection(llm_index=0), self.prompt_reflection(llm_index=1)]
    ...
    def prompt_reflection(self, llm_index: int = 0) -> str:
        return format_step(self.reflect_llm[llm_index](self._build_reflection_prompt()))
